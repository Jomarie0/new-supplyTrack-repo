    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, decimal_places=2, help_text="Price for this specific variant. If blank, defaults to product's base price.", max_digits=10, null=True)),
